...
/**
 * Authenticated principal representation for an Equipment Partner in Spring Security.
...
public class PartnerPrincipal implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return Collections.singletonList(new SimpleGrantedAuthority("ROLE_" + (role != null ? role : "PARTNER")));
    }
