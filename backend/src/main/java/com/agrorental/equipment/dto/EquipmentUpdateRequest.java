...
/**
 * Request DTO representing mutable equipment fields during update operations.
 * Excludes partnerId to prevent accidental ownership transfer via normal updates.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class EquipmentUpdateRequest {
    ...
    @NotNull(message = "Disabled status is mandatory")
